...
void setup() {
	...
	uView.clear(PAGE);	// erase the memory buffer, when next uView.display() is called, the OLED will be cleared.
        ...
        mySerial.println("MicroView Demo Running!");
}
...
void loop() {
        ...
        mySerial.println("MicroView Demo Starting...");
	...
	for (i=0; i<150;i++) {
        ...
        mySerial.println("Rectangle Demo.");
	...
	delay(500);
        ...
        mySerial.println("Multiple Font Demo.");
